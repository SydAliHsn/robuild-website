        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
                  ...
                  {menuData.map((menuItem, index) => (
                    <li key={index} className="group relative">
                      {menuItem.path ? (
                        <Link
                          href={menuItem.path}
                          className={`font-medium flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${usePathName === menuItem.path
                            ? "text-primary dark:text-white"
                            : "text-dark/90 hover:text-primary dark:text-white/70 dark:hover:text-white"
                            }`}
                        >
                          {menuItem.title}
                        </Link>
            ...
            <div className="flex items-center justify-end pr-16 lg:pr-0">
              ...
              <Link
                href="/signin"
                className="ease-in-up shadow-btn hover:shadow-btn-hover hidden rounded-full bg-[#fed203] lg:px-9 px-7 py-3 text-base font-semibold text-white transition duration-300 hover:bg-opacity-90 md:block mx-2"
              >
                Sign In
              </Link>
              <div>
